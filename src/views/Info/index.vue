...
export default {
  ...
  setup(props, { root }) {
    ...
    return {
      // ref
      category_value,date_value,search_key,search_keyWork,dialog_info, total, page,
      loadingData,deleteInfoId,dialog_info_edit,infoEdit,
      // reactive
      options,search_options,table_data,
      // function 
      handleCurrentChange,handleSizeChange,toData,toCategory, handleSelectionChange,getList,editInfo,
      // closeDialog
